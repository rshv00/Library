...
<div class="container_24">
    ...
    <div class="main">
        <p class="title" id="users_t">Users</p>
        <p class="t2">All</p>
        ...
        <p class="t2" style="margin-top: 40px;">*Who has not been returning as minimum as 1 book for more than 30
            days</p>
        <%--</c:if>--%>
    </div>
</div>
